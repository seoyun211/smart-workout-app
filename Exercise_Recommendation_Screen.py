...
class ExerciseRecommendationScreen(Screen):
    def __init__(self, **kwargs):
        ...
        # BMI 결과별 추천 운동 데이터
        self.exercise_data = {
            "저체중": {"운동": "근력 운동 (스쿼트, 푸쉬업, 데드리프트)", "이미지": "images/weight_gain.png"},
            "정상체중": {"운동": "유산소 + 근력 운동 (러닝, 요가, 필라테스)", "이미지": "images/normal.png"},
            "과체중": {"운동": "유산소 중심 운동 (빠르게 걷기, 사이클, 수영)", "이미지": "images/overweight.png"},
            "비만": {"운동": "고강도 유산소 운동 (HIIT, 인터벌 트레이닝)", "이미지": "images/obesity.png"}
        }
